                    ...
                    <tbody class="divide-y">
                        ...
                        @foreach($products as $product)
                            <tr @if($loop->even)class="bg-gray-100"@endif>
                                ...
                                <td class="px-4 py-3">
                                    <img alt="ecommerce" class="object-cover object-center w-full h-full block" src="{{ $product->coverUrl }}">
                                </td>
                                ...
                                <td class="px-4 py-3 text-sm text-right space-x-3 text-gray-900">
                                    ...
                                    <a href="{{ route('admin.products.delete', $product->id) }}" class="mt-3 text-indigo-500 inline-flex items-center">Deletar</a>
                                </td>
                            </tr>
                        @endforeach
